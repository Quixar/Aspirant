...
protected:
    ...
    vector<int> grade_of_practic;  /// Массив оценок за практику
    vector<int> grade_of_homework; /// Массив оценок за домашние задания
    vector<int> grade_of_exam;     /// Массив оценок за экзамены
